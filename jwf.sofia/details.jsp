...
<salmon:validator name="errorMessage" visible="false" breaksafter="2" 
	...
	validatorclass="sofiademo.PersonValidator" datasource="jsf
 ...
 <salmon:box name="box1"><salmon:displaybox name="displaybox1" caption="Details"><salmon:displayboxheader>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td> <salmon:input type="text" name="firstname" size="16" maxlength="255" datasource="jsf:person.firstname"></salmon:input></td>
          <td> <salmon:text name="capLastName" text="Last Name" font="ColumnCaptionFont"/></td>
          <td> <salmon:input type="text" name="lastname" size="16" maxlength="255" datasource="jsf:person.lastname"></salmon:input></td>
        </tr>
        <tr>
          <td><salmon:text name="capEmail" text="EMail" font="ColumnCaptionFont"/></td>
          <td colspan="3"> <salmon:input type="text" name="email" size="64" maxlength="255" datasource="jsf:person.email"></salmon:input></td>
        </tr>
        <tr>
          <td><salmon:text name="capAddress1" text="Address" font="ColumnCaptionFont"/></td>
          <td colspan="3"> <salmon:input type="text" name="address1" size="64" maxlength="255" datasource="jsf:person.address1"></salmon:input></td>
        </tr>
       <tr>
          <td><salmon:text name="capAddress2" text="(continued)" font="ColumnCaptionFont"/></td>
          <td colspan="3"> <salmon:input type="text" name="address2" size="64" maxlength="255" datasource="jsf:person.address2"></salmon:input></td>
        </tr>        
        <tr>
          <td><salmon:text name="capCity" text="City" font="ColumnCaptionFont"/></td>
          <td><salmon:input type="text" name="city" size="16" maxlength="255" datasource="jsf:person.city"></salmon:input></td>
          <td><salmon:text name="capState" text="Province/State" font="ColumnCaptionFont"/></td>
          <td><salmon:input type="state" name="province" datasource="jsf:person.province"></salmon:input></td>
        </tr>
        <tr>
          <td><salmon:text name="capZip" text="PostCode" font="ColumnCaptionFont"/></td>
          <td><salmon:input type="zip" name="postcode" datasource="jsf:person.postcode"></salmon:input></td>
         </tr>
      </table>
  ...
  <salmon:input type="hidden" name="id" value="-1" datasource="jsf:person.id"></salmon:input>
</salmon:form>
